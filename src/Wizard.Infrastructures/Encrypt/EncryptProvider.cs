...
using System.Text;
using Wizard.Infrastructures.Encrypt.Exception;
using Wizard.Infrastructures.Encrypt.Extensions.Internal;
using Wizard.Infrastructures.Encrypt.Internal;
using Wizard.Infrastructures.Encrypt.Shared;

namespace Wizard.Infrastructures.Encrypt
{
    public class EncryptProvider
    {
        ...
        /// <param name="srcString">src string</param>
        /// <param name="padding">
        /// rsa encryptPadding <see cref="RSAEncryptionPadding"/> RSAEncryptionPadding.Pkcs1 for
        /// linux/mac openssl
        /// </param>
        /// <returns>encrypted string</returns>
        ...
        /// 使用加密服务提供程序实现加密生成随机数
        ///
        /// 说明： validationKey 的值可以是48到128个字符长，强烈建议使用可用的最长密钥 decryptionKey 的值可以是16到48字符长，建议使用48字符长
        ///
        /// 使用方式： string decryptionKey = EncryptManager.CreateMachineKey(48); string validationKey = EncryptManager.CreateMachineKey(128);
        /// </summary>
