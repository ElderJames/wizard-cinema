<template>
    <Layout :has_share="false" title="首页">
        <div class="page_wrap">
            <div class="page_bd">
                <div class="content" v-if="loading !== 'loading'">
                    ...
                    <div class="list">
                        <div class="title">
                            <mu-list class="mulist">
                                <mu-list-item :title="`总共${movies.total}个活动`" to="movie">
                    ...
                    <div class="list">
                        <div class="title">
                            <mu-list class="mulist">
                                <mu-list-item :title="`即将举办${movies.totalComingMovie}个`" to="tv">
                                    <mu-icon slot="right" value="keyboard_arrow_right" />
                                </mu-list-item>
                            </mu-list>
                        </div>
...
export default {
  ...
  methods: {
    getLocationMovies() {
      ...
      this.$store
        .dispatch("getLocationMovies", params)
        .then(response => {
