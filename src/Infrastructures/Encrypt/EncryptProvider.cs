...
using System.Text;
using Infrastructures.Encrypt.Exception;
using Infrastructures.Encrypt.Extensions.Internal;
using Infrastructures.Encrypt.Internal;
using Infrastructures.Encrypt.Shared;

namespace Infrastructures.Encrypt
{
